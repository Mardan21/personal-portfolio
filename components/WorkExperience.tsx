...
export default function WorkExperience({ experiences }: Props) {
  ...
  return (
    <div className="kunaiCursor h-screen flex relative overflow-hidden flex-col text-left md:flex-row max-w-full px-10 justify-evenly mx-auto items-center">
        ...
        <div className="kunaiCursor w-screen md:w-full text-left flex space-x-5 overflow-x-scroll p-8 pt-[70%] sm:pt-[100%] md:pt-[0] lg:pt-[10px] md:pb-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#FF4500]">
