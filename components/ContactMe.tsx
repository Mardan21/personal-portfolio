...
//         <h4 className="ninjaText text-sm sm:text-lg md:text-2xl lg:text-3xl 2xl:text-4xl font-semibold text-center text-[#fff]/90">
...
//             <p className="ninjaText text-sm sm:text-lg md:text-2xl lg:text-2xl tracking-[2px] text-[#fff]/90 group-hover:text-[#ff4500] transition-colors duration-300">
...
//               {...register("name")}
//               placeholder="Name"
//               className="ninjaText text-[#fff] placeholder-[#fff]/60 kunaiCursor bg-[#000]/20 border border-[#ff4500]/30 rounded-lg px-4 py-3 focus:border-[#e31e24] focus:outline-none focus:ring-2 focus:ring-[#ff4500]/20 hover:border-[#ff4500] transition-all duration-300 w-64 md:w-auto"
//               type="text"
//             />
//             <input
//               {...register("email")}
...
//             placeholder="Message"
//             rows={4}
//             className="ninjaText text-[#fff] placeholder-[#fff]/60 kunaiCursor bg-[#000]/20 border border-[#ff4500]/30 rounded-lg px-4 py-3 focus:border-[#e31e24] focus:outline-none focus:ring-2 focus:ring-[#ff4500]/20 hover:border-[#ff4500] transition-all duration-300 resize-none"
//           />

//           <button
//             type="submit"
//             className="bg-gradient-to-r from-[#ff4500] to-[#e31e24] narutoText2 rasenganCursor tracking-[4px] py-3 md:py-5 px-10 rounded-lg text-[#fa5000] font-bold text-2xl md:text-4xl hover:from-[#e31e24] hover:to-[#ff4500] hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-[#ff4500]/25"
//           >
//             Let&apos;s Connect
//           </button>
//         </form>
...
export default function ContactMe() {
  ...
  return (
    <div className="kunaiCursor flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center sm:h-[70vh] md:h-[70vh] lg:h-[80vh] 2xl:h-screen">
      <motion.h3
